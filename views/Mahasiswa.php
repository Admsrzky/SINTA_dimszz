...
<div class="container mt-5">
    ...
    <a href="../model/Excel/Mahasiswa_Excel.php" class="btn btn-success p-1 fs-5 mb-3 float-end" value="Excel"><i class='bx bx-table mx-2 p-1'></i></a>
    <a href="../Model/PrintMahasiswa.php" class="btn btn-danger p-1 fs-5 mb-3 mx-3 float-end" value="Print"><i class='bx bx-import mx-2 p-1'></i></a>
    <a href="../Model/pdf/Mahasiswa_Pdf.php" class="btn btn-danger p-1 fs-5 mb-3 float-end px-2" value="PDF">PDF</a>
